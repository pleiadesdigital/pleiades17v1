...
function pleiades17_setup() {
	 ...
	 * Translations can be filed at WordPress.org. See: https://translate.wordpress.org/projects/wp-themes/pleiades17
	 * If you're building a theme based on Twenty Seventeen, use a find and replace
	 * to change 'pleiades17' to the name of your theme in all the template files.
	 */
	 ...
	 * specifically font, colors, and column width.
 	 */
	add_editor_style( array( 'assets/css/editor-style.css', pleiades17_fonts_url() ) );
	 ...
	 */
	$starter_content = apply_filters( 'pleiades17_starter_content', $starter_content );
...
function pleiades17_fonts_url() {
	 ...
	 */
	$libre_franklin = _x( 'on', 'Libre Franklin font: on or off', 'pleiades17' );
 ...
 */
function pleiades17_resource_hints( $urls, $relation_type ) {
	if ( wp_style_is( 'pleiades17-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		$urls[] = array(
...
add_filter( 'wp_resource_hints', 'pleiades17_resource_hints', 10, 2 );
...
function pleiades17_scripts() {
	...
	wp_enqueue_style( 'pleiades17-fonts', pleiades17_fonts_url(), array(), null );
